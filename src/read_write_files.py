...
class ReadWriteFiles():
    ...
    def __init__(self) -> None:
        ...
        self.project_dir = self.current_dir if self.current_dir.parts[-1]=='immo-eliza-data-analysis'else[p for p in self.current_dir.parents if p.parts[-1]=='immo-eliza-data-analysis'][0]
